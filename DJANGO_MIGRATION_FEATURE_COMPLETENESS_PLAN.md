...
- Account settings for provider selection, OpenAI/Anthropic models, encrypted API keys, and Codex login.
...
- **Retired integration:** The experimental Autumn timer was later removed from the Django app.
...
6. Add live job-status polling and explicit Whisper cache clearing.
...
- [x] Expand account settings with local Whisper tuning.
...
- [x] Retire the experimental Autumn timer integration after product review.
